...
(function (Shumway) {
    ...
    (function (AVMX) {
        AVMX.Errors = {
            ...
            ProxyGetPropertyError: { code: 2088, message: "The Proxy class does not implement getProperty." },
            ProxySetPropertyError: { code: 2089, message: "The Proxy class does not implement setProperty." },
            ProxyCallPropertyError: { code: 2090, message: "The Proxy class does not implement callProperty." },
            ProxyHasPropertyError: { code: 2091, message: "The Proxy class does not implement hasProperty." },
            ProxyDeletePropertyError: { code: 2092, message: "The Proxy class does not implement deleteProperty." },
            ProxyGetDescendantsError: { code: 2093, message: "The Proxy class does not implement getDescendants." },
            ProxyNextNameIndexError: { code: 2105, message: "The Proxy class does not implement nextNameIndex." },
            ProxyNextNameError: { code: 2106, message: "The Proxy class does not implement nextName." },
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        function checkParameterType(argument, name, type, allowNull) {
            if (argument == null) {
                if (allowNull) {
                    return;
                }
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        (function (AS) {
            ...
            })(AS.XMLParserErrorCode || (AS.XMLParserErrorCode = {}));
            var XMLParserErrorCode = AS.XMLParserErrorCode;
                    ...
                    var XMLNode = (function (_super) {
                        ...
                        XMLNode.escapeXML = function (value) {
                            ...
                            while (i < length) {
                                ...
                                if (ch === 39 /* APOS */ || ch === 38 /* AMP */ || ch === 34 /* QUOT */ || ch === 60 /* LT */ || ch === 62 /* GT */) {
                                    break;
                                }
                                i++;
                            }
