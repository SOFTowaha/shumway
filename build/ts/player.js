                ...
                PlayerChannelSerializer.prototype._writeFilters = function (filters) {
                    ...
                    for (var i = 0; i < filters.length; i++) {
                        ...
                        if (blurFilterClass.axIsType(filter)) {
                            ...
                            this.output.writeInt(2 /* ColorMatrix */);
                            for (var j = 0; j < 20; j++) {
...
(function (Shumway) {
    ...
    (function (_Player) {
        ...
        var CrossDomainSWFLoadingWhitelistResult = flash.system.CrossDomainSWFLoadingWhitelistResult;
        var MessageTag = Shumway.Remoting.MessageTag;
        ...
        var Player = (function () {
            ...
            Player.prototype.load = function (url, buffer) {
                ...
                this.addToSWFLoadingWhitelist(Shumway.FileLoadingService.instance.resolveUrl(url), false, true);
