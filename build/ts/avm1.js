...
(function (Shumway) {
    ...
    (function (AVM1) {
        ...
        function alIsArrayObject(context, v) {
            if (!(v instanceof AVM1Object)) {
                return false;
            }
        ...
        AVM1.alIsArrayObject = alIsArrayObject;
        ...
        (function (Natives) {
            ...
            var AVM1ArrayPrototype = (function (_super) {
                ...
                AVM1ArrayPrototype.prototype.concat = function () {
                    ...
                    var a = [];
                    var e = this;
                    var isArrayObject = AVM1.alIsArrayObject(this.context, this);
                    var i = 0;
                    while (true) {
                        if (isArrayObject) {
    ...
    (function (AVM1) {
        ...
        var AVM1Context = (function () {
            ...
            AVM1Context.prototype.resolveLevel = function (level) {
                ...
                var as3Stage = this.globals.Stage._as3Stage;
                // TODO currently there is only one (_level0)
                var as3Loader = as3Stage._lookupChildByIndex(level, 2 /* INCLUDE_NON_INITIALIZED */);
                if (!as3Loader) {
    ...
    (function (AVM1) {
        ...
        (function (Lib) {
            ...
            var AVM1SymbolBase = (function (_super) {
                ...
                Object.defineProperty(AVM1SymbolBase.prototype, "as3ObjectOrTemplate", {
                    get: function () {
                ...
                AVM1SymbolBase.prototype._getAS3ObjectTemplate = function () {
                ...
                AVM1SymbolBase.prototype.getFilters = function () {
                    return Lib.convertFromAS3Filters(this.context, this.as3Object.filters);
                };
                AVM1SymbolBase.prototype.setFilters = function (value) {
                    this.as3Object.filters = Lib.convertToAS3Filters(this.context, value);
                };
                ...
                AVM1SymbolBase.prototype.setOpaqueBackground = function (value) {
                    if (Shumway.isNullOrUndefined(value)) {
                        ...
                        this.as3Object.opaqueBackground = AVM1.alToInt32(this.context, value);
                    }
                };
                ...
                AVM1SymbolBase.prototype.getScale9Grid = function () {
                    return Lib.AVM1Rectangle.fromAS3Rectangle(this.context, this.as3Object.scale9Grid);
                };
                AVM1SymbolBase.prototype.setScale9Grid = function (value) {
                    this.as3Object.scale9Grid = Shumway.isNullOrUndefined(value) ? null : Lib.toAS3Rectangle(value);
                };
                AVM1SymbolBase.prototype.getScrollRect = function () {
                    return Lib.AVM1Rectangle.fromAS3Rectangle(this.context, this.as3Object.scrollRect);
                };
                AVM1SymbolBase.prototype.setScrollRect = function (value) {
                    this.as3Object.scrollRect = Shumway.isNullOrUndefined(value) ? null : Lib.toAS3Rectangle(value);
                };
                ...
                AVM1SymbolBase.prototype.setTabIndex = function (value) {
                    if (Shumway.isNullOrUndefined(value)) {
                        ...
                        this.as3Object.tabIndex = AVM1.alToInteger(this.context, value);
                    }
                };
                ...
                AVM1SymbolBase.prototype.getTransform = function () {
                    var TransformClass = this.context.globals.alGet('flash').alGet('geom').alGet('Transform');
                ...
                AVM1SymbolBase.prototype.getDepth = function () {
                    return this.as3Object._depth - Lib.DEPTH_OFFSET;
                };
                return AVM1SymbolBase;
            })(AVM1.AVM1Object);
            Lib.AVM1SymbolBase = AVM1SymbolBase;
            Lib.BlendModesMap = [undefined, "normal", "layer", "multiply", "screen", "lighten", "darken", "difference", "add", "subtract", "invert", "alpha", "erase", "overlay", "hardlight"];
            ...
            function initializeAVM1Object(as3Object, context, placeObjectTag) {
                ...
                for (var j = 0; j < events.length; j++) {
                    ...
                    if (swfEvent.actionsBlock) {
                        actionsData = context.actionsDataFactory.createActionsData(swfEvent.actionsBlock, 's' + placeObjectTag.symbolId + 'e' + j);
        ...
        (function (Lib) {
            ...
            var AVM1MovieClip = (function (_super) {
                ...
                AVM1MovieClip.prototype._constructMovieClipSymbol = function (symbolId, name) {
                    symbolId = AVM1.alCoerceString(this.context, symbolId);
                    name = AVM1.alCoerceString(this.context, name);
                ...
                AVM1MovieClip.prototype.duplicateMovieClip = function (name, depth, initObject) {
                    ...
                    mc.name = AVM1.alCoerceString(this.context, name);
                ...
                AVM1MovieClip.prototype.setTabChildren = function (value) {
                    this.as3ObjectOrTemplate.tabChildren = AVM1.alToBoolean(this.context, value);
                };
                ...
                AVM1MovieClip.prototype.setTrackAsMenu = function (value) {
                    this.as3ObjectOrTemplate.trackAsMenu = AVM1.alToBoolean(this.context, value);
                };
                ...
                AVM1MovieClip.prototype.alGetOwnProperty = function (p) {
                    ...
                    if (name[0] === '_') {
                        ...
                        if (AVM1.PropertiesIndexMap.indexOf(name.toLowerCase()) >= 0) {
        ...
        (function (Lib) {
            ...
            var AVM1Button = (function (_super) {
                ...
                AVM1Button.prototype.setUseHandCursor = function (value) {
                    this._as3Object.useHandCursor = AVM1.alToBoolean(this.context, value);
                };
            ...
            var AVM1BitmapData = (function (_super) {
                ...
                AVM1BitmapData.loadBitmap = function (context, symbolId) {
                    ...
                    if (symbol && (bitmapClass === symbolClass || bitmapClass.dPrototype.isPrototypeOf(symbolClass.dPrototype))) {
                        ...
                        var BitmapData = context.globals.alGet('flash').alGet('display').alGet('BitmapData');
                ...
                AVM1BitmapData.prototype.clone = function () {
                    ...
                    var BitmapData = this.context.globals.alGet('flash').alGet('display').alGet('BitmapData');
                    bitmap.alPrototype = BitmapData.alGetPrototypeProperty();
                ...
                AVM1BitmapData.prototype.perlinNoise = function (baseX, baseY, numOctaves, randomSeed, stitch, fractalNoise, channelOptions, grayScale, offsets) {
                    ...
                    var as3Offsets = null;
                    if (!Shumway.isNullOrUndefined(offsets)) {
                        for (var i = 0, length = offsets.alGet('length'); i < length; i++) {
                            as3Offsets.push(AVM1.alCoerceNumber(this.context, offsets.alGet(i)));
                        }
                    }
    ...
    (function (AVM1) {
        ...
        (function (Lib) {
            ...
            function createFiltersClasses(context) {
                ...
                createFilterClass(context, filters, base, 'BevelFilter', ['distance', 'Number', 'angle', 'Number', 'highlightColor', 'Number', 'highlightAlpha', 'Number', 'shadowColor', 'Number', 'shadowAlpha', 'Number', 'blurX', 'Number', 'blurY', 'Number', 'strength', 'Number', 'quality', 'Number', 'type', 'String', 'knockout', 'Boolean']);
                ...
                createFilterClass(context, filters, base, 'ConvolutionFilter', ['matrixX', 'Number', 'matrixY', 'Number', 'matrix', 'Numbers', 'divisor', 'Number', 'bias', 'Number', 'preserveAlpha', 'Boolean', 'clamp', 'Boolean', 'color', 'Number', 'alpha', 'Number']);
                createFilterClass(context, filters, base, 'DisplacementMapFilter', ['mapBitmap', 'BitmapData', 'mapPoint', 'Point', 'componentX', 'Number', 'componentY', 'Number', 'scaleX', 'Number', 'scaleY', 'Number', 'mode', 'String', 'color', 'Number', 'alpha', 'Number']);
                createFilterClass(context, filters, base, 'DropShadowFilter', ['distance', 'Number', 'angle', 'Number', 'color', 'Number', 'alpha', 'Number', 'blurX', 'Number', 'blurY', 'Number', 'strength', 'Number', 'quality', 'Number', 'inner', 'Boolean', 'knockout', 'Boolean', 'hideObject', 'Boolean']);
                createFilterClass(context, filters, base, 'GlowFilter', ['color', 'Number', 'alpha', 'Number', 'blurX', 'Number', 'blurY', 'Number', 'strength', 'Number', 'quality', 'Number', 'inner', 'Boolean', 'knockout', 'Boolean']);
                createFilterClass(context, filters, base, 'GradientBevelFilter', ['distance', 'Number', 'angle', 'Number', 'colors', 'Numbers', 'alphas', 'Numbers', 'ratios', 'Numbers', 'blurX', 'Number', 'blurY', 'Number', 'strength', 'Number', 'quality', 'Number', 'type', 'String', 'knockout', 'Boolean']);
                createFilterClass(context, filters, base, 'GradientGlowFilter', ['distance', 'Number', 'angle', 'Number', 'colors', 'Numbers', 'alphas', 'Numbers', 'ratios', 'Numbers', 'blurX', 'Number', 'blurY', 'Number', 'strength', 'Number', 'quality', 'Number', 'type', 'String', 'knockout', 'Boolean']);
                return filters;
            }
            ...
            var knownFilters = ['BevelFilter', 'BlurFilter', 'ColorMatrixFilter', 'ConvolutionFilter', 'DisplacementMapFilter', 'DropShadowFilter', 'GlowFilter', 'GradientBevelFilter', 'GradientGlowFilter'];
        ...
        (function (Lib) {
            ...
            var AVM1XMLNodeFunction = (function (_super) {
                ...
                AVM1XMLNodeFunction.prototype.alConstruct = function (args) {
                    ...
                    if (type !== 1 /* ELEMENT_NODE */ && type !== 3 /* TEXT_NODE */) {
            ...
            var AVM1XMLNodeChildNodes = (function (_super) {
                ...
                function AVM1XMLNodeChildNodes(context, as3XMLNode) {
                    ...
                    this._cachedNodePropertyDescriptor = {
                        flags: 64 /* DATA */ | 2 /* DONT_DELETE */ | 4 /* READ_ONLY */,
                        value: undefined
                    };
                    AVM1.alDefineObjectProperties(this, {
                        length: {
